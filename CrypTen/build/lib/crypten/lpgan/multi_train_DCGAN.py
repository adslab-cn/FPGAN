...
#                                                  padding=0,
#                                                  bias=False)
#         self.bn1 = crypten.nn.BatchNorm2d(ngf*4)
#         self.decon2 = crypten.nn.ConvTranspose2d(ngf*4, ngf*2, 4, stride=2, padding=1, bias=False)  
#         self.bn2 = crypten.nn.BatchNorm2d(ngf*2)
#         self.decon3 = crypten.nn.ConvTranspose2d(ngf*2, ngf, 4, stride=2, padding=1, bias=False)  
#         self.bn3 = crypten.nn.BatchNorm2d(ngf)
#         self.decon4 = crypten.nn.ConvTranspose2d(ngf, nc, 4, stride=2, padding=1, bias=False)
#         self.relu = crypten.nn.ReLU()
...
class Discriminator(nn.Module):
    def __init__(self, ngpu):
        ...
        self.leaky_relu1 = nn.LeakyReLU(0.2, inplace=False)
    ...
    def forward(self, input):
        ...
        out = out.view(out.size(0), -1).mean(dim=1)  # Flatten and take mean
        return out
...
def run_lpgan():
    ...
    if rank == ALICE:
        ...
        '''
        with open('experiment/encrypted_real_images_alice.pkl', 'rb') as f:
    ...
    for epoch in range(num_epochs):
        ...
        for i, real_images in enumerate(encrypted_real_images):
            ...
            # print("real_images's size:", real_images.size())
